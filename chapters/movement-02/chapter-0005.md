...
story_time:
  ...
  opens: "Just after midnight, when the building vibrates again: the main control room, then the southern perimeter"
  elapsed: "from the second vibration to the return from the boundary"
objective: "Go to the boundary and measure what is actually on the other side of it, on the settlement's side of the line and with Sarah on the comm."
locations: ["The main control room", "The southern perimeter road"]
characters: [Jack, Sarah, "Lena Ortiz", "Mark Jones, perimeter security"]
status_changes:
  - "The vibrations are not regular and their source is moving"
  - "The TOMBS logs are clean in the same way the security logs were clean before the activation; whoever did this had control, not just access"
  - "Lena arrives in person; Mark Jones, perimeter security, introduces himself at the door and offers Jack the ride to the boundary"
  - "Sarah refuses, then lets Jack go, and stays behind to monitor TOMBS, the cameras and his sensor feed"
  - "The air, temperature and pressure beyond the boundary are normal"
  - "A human fingernail clipping lies at the boundary, longer than Jack is tall"
  - "Something with several thin legs moves through the grass toward the settlement"
new_canon:
  - "The boundary is invisible: pavement simply stops and soil begins"
  - "Outside air is breathable; the danger beyond the edge is scale, not atmosphere"
  - "Mark Jones is the settlement's perimeter security officer"
...
Jack overlaid the reports on the settlement map. The first vibrations had been strongest near the eastern boundary. Later reports came from the north.

"Or whatever is causing them is."
...
Jack closed the vibration map and opened the TOMBS event record again. The same final entry waited for him.

Boundary event complete.
...
Sarah noticed where he had gone. "Still nothing?"

"The logs are too clean."

"Like the security logs before activation."

Jack nodded. "Exactly like them."

He searched the event sequence for a source address. Nothing. Authentication history had been stripped. Remote command records existed, but every identifying field was blank.

Sarah rolled her chair closer. "Could TOMBS erase that itself?"

"It could delete logs if an administrator ordered it."

"But you didn't."

"No."

Sarah studied the screen. "Then whoever did this had more than remote access."
...
Lena stood outside, still in her orange utility jacket. She held up both hands before either of them could ask.
...
A security officer stood just outside it, radio clipped to his shoulder, careful not to step past the threshold. "Doctor Bennett?"
...
Jack found Mark waiting by the utility vehicle. Sarah and Lena stayed connected through his wrist terminal the whole way.
...
Sarah's voice cut in over the comm. "I heard that."

Mark grinned and said nothing else.

As they approached the edge of the developed zone, the road seemed normal until it suddenly wasn't.

The pavement ended in a perfectly straight line.

Beyond it rose wilderness.
...
Sarah's voice came through his wrist. "Readings?"
...
Jack crouched near the end of the pavement.

The boundary itself was invisible.

There was no glowing wall, no distortion, no lingering TOMBS field. Asphalt simply stopped and soil began.

He reached toward the edge.

Sarah's voice sharpened immediately. "Jack."

"My hand is still on our side."

"You are genetically incapable of saying that reassuringly."

Jack let out a chuckle while moving the sensor closer.
...
Jack watched the surface of the droplet tremble. "It's water."

"That doesn't make it less unpleasant."

Sarah's voice came through his wrist. "Don't touch it."
...
Something pale lay half buried in the soil.

He moved several steps down the pavement, staying well inside the developed zone.

Mark swept his light toward it. "Hey Jack, what's that look like to you?"
...
Fine ridges crossed its surface.

"No."

He had seen objects like it his entire life, usually without thinking about them.

Mark squinted at the screen. "...Fingernail?"

Jack went still. "Yeah. Actually — yeah."
...
Not a fingernail attached to a finger.

A clipping.

Discarded somewhere on the island before tonight, unnoticed among dirt and grass.

Now it stretched longer than Jack was tall.

Nobody spoke for several seconds.

The grass above them shifted.

Jack looked up.

A vibration rolled through the ground.

This time, there was no doubt where it came from.

Something was moving through the wilderness.

Mark raised his light.

Jack backed toward the vehicle. "We're done. Let's move."

The grass stems moved one after another in the darkness, not with the wind but in a line approaching the settlement.

Sarah's voice came through his wrist. "Jack, what's happening?"

He climbed into the vehicle without taking his eyes off the boundary.

"Something's coming."

Mark started the vehicle's motor.

A dark shape passed between two enormous blades of grass.

For one instant, Jack caught the outline of several thin legs.

Then it vanished behind the soil ridge.

He shut the door.

"Go."

The vehicle accelerated away from the boundary.

Behind them, the grass kept moving.
