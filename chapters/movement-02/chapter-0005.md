...
story_time:
  ...
  opens: "Two in the morning, in the main control room and then at the southern perimeter"
  elapsed: "from the settlement-wide announcement to the return from the boundary"
objective: "Tell the settlement the truth without promising a reversal, then go to the boundary and measure what is actually on the other side of it."
locations: ["The main control room", "The southern perimeter road", "The settlement, by broadcast"]
characters: [Jack, Sarah, "Lena Ortiz", "Settlement security officers"]
status_changes:
  - "Jack makes the first official settlement-wide announcement at about two in the morning"
  - "Water is the first hard limit: several days at normal consumption, longer under restriction"
  - "The vibrations are not regular and their source is moving"
  - "The TOMBS logs are clean in the same way the security logs were clean before the activation"
  - "Sarah stays behind rather than go to the boundary, and sends Jack with an environmental sensor"
  - "The air, temperature and pressure beyond the boundary are normal"
  - "A human fingernail clipping lies at the boundary, longer than Jack's arm"
...
One security officer whispered, "That's grass."
...
One of the officers shone a light across the soil. Something glittered near the base of the ridge.

Jack adjusted his flashlight.

A droplet of water clung beneath a grass blade.

It was larger than his head.

The security officer took a step backward. "That is deeply unpleasant."
...
Sarah asked, "What do you see?"

"Not sure."

Jack zoomed his wrist camera.

The pale object curved upward from the dirt, smooth and translucent at one end.

One of the officers stared at it. "Is that plastic?"
...
Sarah recognized it from the video feed first.

"Jack, that's a fingernail."
...
Now it was longer than Jack's arm.
...
The security officers raised their lights.

Jack backed toward the vehicle. "We're done. Everybody in."
