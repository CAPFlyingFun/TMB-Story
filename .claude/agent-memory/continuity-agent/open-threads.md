...
On approval, bible needs: LOCATIONS Bennett home (rooms as listed in equipment.md DRAFT block) + station lab/skylight/log now on the page; CHARACTERS Rachel (Tidewater on the page, the fleece, "does their units", knows Ines, answers with instructions, the letter), Daniel (photograph; fixed words verbatim), Nora (kit sheet, two-count, stairs), Caleb; CREATURES moth entry; MYSTERIES M33 introduced (the words, c2:213), M13 advanced (letter c2:73, text 3 c2:237, logger-before-saddle c2:153, the 23:15 look c2:263), who-knows-what per knowledge.md; TIMELINE row (Tue 18:45–23:20; Saturday 08:00 skiff); CHAPTER_INDEX row.
