...
Living canon. One entry per character; fields stay in this order so agents can grep
them. Update only on chapter approval (see `outline/WORKFLOW.md` §8). Locked facts
come from `architecture/SERIES_ARCHITECTURE.md`; everything else is established by
approved chapters and cites the chapter that established it (`[ch 0012]`).

Entry template:

### Name
- **Status:** active main cast | recurring | temporary arc | off-roster (may return) | deceased
- **Age / where born:**
- **Role:**
- **Appearance:** (only what the page has said)
- **Voice:** vocabulary, rhythm, tics — what makes them identifiable without a tag
- **Personality / blind spots:**
- **Skills:** what they can safely attempt, and what they cannot yet
- **Relationships:** one line per person that matters
- **Injuries / condition:**
- **Equipment:**
- **Knows:** / **Does not know:** (cross-check `MYSTERIES.md`)
- **Secrets kept, and from whom:**
- **Current location / goal:**
- **Arc so far:** chapter-cited bullets
- **Locked / provisional:** which of the above is architecture-locked
...
### Caleb Bennett
- **Status:** active main cast · **Age:** 18 · **Role:** seasonal field assistant, Alder Sound (three weeks in at Ch. 1; got in on a summer of trail crew and a teacher's letter he was never allowed to read).
- **Voice:** short, plain, argues for fun and loses gracefully ("Ha." "You said."); talks to animals ("Hey," to a gull).
- **Personality / blind spots:** notices creatures before instruments; lies down in wet weed to watch ants; follows a line of ants uphill because they are "the interesting thing"; walks past the summit box "the way you look at a parked car". Does not see what Nora sees on her phone.
...
- **Voice:** precise, dry, wins by definition ("I didn't say when. I didn't say why. I said."); numbers first, feelings after.
- **Personality / blind spots:** reads instruments before creatures; brings a luggage scale to work; keeps the dry bag "like a baby"; notices what Caleb does not (Mom's second text) and does not say so.
...
- **Voice `[ch 0002, in review]`:** imperatives as affection ("Boots off. Both of you. Not on the mat, on the step."); answers questions with instructions ("Pass your brother the salt"); bench vocabulary leaks when she is interested ("Step, or ramp?", "A step is an instrument. A ramp is weather.", "Thirty-five grams to the liter, hon."); "That's allowed."
- **The fixed words (M33), verbatim, six sentences and a closer:** "Your father did research. He went out on a research trip. The boat was lost off the coast. Nobody was ever found. Eighteen years ago. That's the whole story." Closer: "Pass your brother the salt."
...
## Island cast (enter from Part One's end / Part Two)
...
### Professor Adrian Kessler
(Version B: not Daniel; former colleague; name provisional per Rev 3 §15)
...
- **Knows `[ch 0003, in review]`:** that the summit enclosure is "from the old program. Before most of us.", and that it was Mercer's. He does not know the twins are Mercer's.
- **Does not know (LOCKED until Joshua says otherwise):** Gus has never connected Rachel Bennett to the Mercer of the old program. He has thirty years at the station and she services its units for Tidewater, so they have certainly crossed paths on a dock; what he has never done is put a Tidewater technician's married name beside a name on a tag from twenty years ago. This is deliberate: Chapter 7 needs Nora to find Rachel's initials on the service tickets herself. If a later chapter wants Gus to make that connection, it is a decision, not a detail.
