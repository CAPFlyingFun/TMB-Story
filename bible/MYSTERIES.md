# Mysteries — the living ladder

Every question has an id. Chapters record ids in `mysteries.introduced/advanced/
answered`; `CHAPTER_INDEX.md` shows them as `+M##`, `~M##`, `=M##`. Part targets are
the architecture's (Rev 2 §17 as revised by Rev 3 §9) and are intentions, not
deadlines; an answer landing outside its range is a decision for
`architecture/DECISIONS.md`, not a drift. The rhythm question → clue →
investigation → answer → bigger question runs every 5–15 chapters. The ladder grows;
new questions get the next id.

**Who knows what** is kept per mystery below the table and is the field most likely to
prevent a contradiction.

## Active ladder

| Id | Question | Introduced | Partial | Full | Status |
|---|---|---|---|---|---|
| M01 | Did Dad survive, reach this island, and did people here know him? | Part 1 | — | Part 3–4 | open |
| M02 | Is the island real? | Part 1 | — | Part 1 | open |
| M03 | Why can't the island be found? | Part 1 | Part 6 | Part 6 | open |
...
| M11 | What is the shield, really? | Part 1/2 | — | Part 2 | open |
| M12 | Why is time distorted here? | Part 4 | Part 9 | Part 16 | open |
| M13 | What is Mom hiding? | Part 1 (subtext) | Part 8 | Part 8/14 | open |
| M14 | Who is the spy? | Part 6 | Part 7 (false suspect: Finn) | Part 9 | open |
| M15 | What does the outside organization want? | Part 6 | Part 13 | Part 15 | open |
| M16 | What role do insect super-colonies play politically? | Part 5 | Part 7 | Part 8 | open |
...
| M24 | Is there more than one island? | — | Parts 12–15 (hints) | Part 20 | not yet introduced |
| M25 | What does the organization do with what it learns? | Part 13 | Part 15 | Part 17 | not yet introduced |
| M26 | Does the settlement's culture survive contact with the wider world? | Part 14 | — | Part 17 | not yet introduced |
...
## Deliberately unknown (never answer without Joshua)
Under the sealed tunnel (M31) · the anomaly's ultimate origin (hold to Part 18) ·
whether Daniel's device discovered or created the phenomenon · full membership of
who funded/knew · more than one island (tease only, until Part 20) · Daniel's exact
current location · the mechanism of bloodline/vision resonance · whether Rachel's
old signal was really from Daniel · the organization's full agenda beyond the story.
